...
def train(BATCH_SIZE):
    images = []
    directory = '/home/sslab/Desktop/sslab-deeplearning/dataset/font_to_img_generator/image-data/hangul_test_fonts/image-data/hangul-images/'
        ...
        for index in range(int(X_train.shape[0]/BATCH_SIZE)):
            ...
            if index % 20 == 0:
                ...
                Image.fromarray(image.astype(np.uint8)).save(
                    "./training_image/"+str(epoch)+"_"+str(index)+".png")
